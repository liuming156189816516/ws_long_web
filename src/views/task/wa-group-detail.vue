<template>
    <div class="">
      <el-form size="small" :inline="true" style="margin-top: 10px;">
        ...
        <el-form-item>
          <el-input clearable :placeholder="$t('sys_mat061',{value:$t('sys_rai083')})" v-model="account" />
        </el-form-item>
        <el-form-item>
      ...
      <el-table ref="opn_table" :data="detailDataList" border height="660" v-loading="loading" element-loading-spinner="el-icon-loading" element-loading-background="rgba(255, 255, 255,1)" style="width: 100%;" :header-cell-style="{ color: '#909399', textAlign: 'center' }" :cell-style="{ textAlign: 'center' }">
        ...
        <el-table-column prop="account" :label="$t('sys_rai083')" minWidth="100" />
        ...
        <el-table-column prop="members" show-overflow-tooltip :label="$t('sys_rai085')" minWidth="130">
          <template slot-scope="scope">
            {{ scope.row.members||"-" }}
          </template>
        </el-table-column>
